            ...
            <div className="flex h-full max-h-screen flex-col gap-2 ">
                ...
                <div className="flex-1 overflow-auto py-2 ">
                    <nav className="grid items-start px-4 text-sm font-medium">
                        {sidebarOptions.map((option) => (
                            <Link
                                className={clsx("flex items-center gap-2 rounded-lg px-3 py-2 text-gray-500 transition-all hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-50", {
                                    "flex items-center gap-2 rounded-lg bg-gray-100 px-3 py-2 text-gray-900  transition-all hover:text-gray-900 dark:bg-primary dark:text-gray-50 dark:hover:text-gray-50": option.href === pathname
                                })}
                                href={option.href}
                            >
                        ...
                        <Link
                            className={clsx("flex items-center gap-2 rounded-lg px-3 py-2 text-gray-500 transition-all hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-50", {
                                "flex items-center gap-2 rounded-lg px-3 py-2 text-gray-900  transition-all hover:text-gray-900 bg-primary dark:text-gray-50 dark:hover:text-gray-50": '/dashboard' === "/dashboard"
                            })}
                            href="/dashboard"
                        >
                            <div className="border rounded-lg dark:bg-black dark:border-gray-800 border-gray-400 p-1 bg-white">
