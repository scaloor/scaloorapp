/**
 * This code is originally taken from tiptap-extension-global-drag-handle
 * https://github.com/NiclasDev63/tiptap-extension-global-drag-handle/blob/master/src/index.ts
 * It has been modified to add the plus button to the editor
 */
...
export interface NodeButtonsOptions {
  /**
...
// This is a custom function to create a plus button
function createPlusButton(view: EditorView) {
...
export function NodeButtonsPlugin(
  options: NodeButtonsOptions & { pluginKey: string },
) {
  let listType = '';
  ...
  return new Plugin({
    ...
    view: (view) => {
      ...
      plusButtonElement = createPlusButton(view);
      hidePlusButton();
    ...
    props: {
      handleDOMEvents: {
        mousemove: (view, event) => {
          ...
          if (!dragHandleElement || !plusButtonElement) return;

          dragHandleElement.style.left = `${rect.left - rect.width}px`;
          dragHandleElement.style.top = `${rect.top}px`;
          showDragHandle();

          plusButtonElement.style.left = `${rect.left - rect.width - options.plusButtonWidth}px`;
...
const NodeButtons = Extension.create({
  name: 'nodeButtons',
  ...
  addProseMirrorPlugins() {
    return [
      NodeButtonsPlugin({
        pluginKey: 'nodeButtons',
        dragHandleWidth: this.options.dragHandleWidth,
        scrollTreshold: this.options.scrollTreshold,
        dragHandleSelector: this.options.dragHandleSelector,
        plusButtonWidth: this.options.plusButtonWidth,
      }),
    ];
  },
});
